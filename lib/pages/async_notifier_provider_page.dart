...
import 'package:my_riverpod_demo/viewModel/async_notifier_list_provider.dart';
...
class AsyncNotifierProviderPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("AsyncNotifier"), backgroundColor: Colors.lightBlue, actions: [
        IconButton(
          icon: const Icon(
            Icons.clear,
            color: Colors.white,
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: Card(
                    ...
                    elevation: 3,
                    child: ListTile(
                      title: Text("${products[index].name}", style: const TextStyle(color: Colors.white, fontSize: 15)),
